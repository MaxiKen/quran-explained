...
| 100-104 (batches AU+AV+AW+AX+AY) | 100:1-104:9 (42 verses; ch 100 11v, 101 11v, 102 8v, 103 3v, 104 9v) | 24 insertions + ~25 whitespace repairs; 4 refs (63:11, 17:30, 24:30, 27:88) all verbatim; all audits 0; all verify PASS | ebbab96 |
| 90 (batch AU) | 90:1–90:20 (SKIP 8, 12, 18, 19, IK gloss is paraphrase of what the section already carries) | 21 insertions + 5 new H2s (v3 Who the Begetter Is; v6 The Verb the Boaster Chose; v11 The Pass Is Defined at Once; v13 The Same Promise Attached to Other Acts; v15 The Kinship Doubles the Gift) + 21 repairs (20 after-header blanks, 1 dangling quote at 90:3); 7 refs touched (42:7, 22:5, 9:60, 17:19, 16:97, plus bare 90:7 and 76:3), all verbatim. Evidence: lā-as-refutation (Mujāhid/Khusayf) + Umm al-Qurā framing; fighting-permission roster + al-Ḥasan's one hour + the second wording of the agreed ḥadīth; Adam/Ibrāhīm/general readings on the begetter; the three kabad readings completed (Ibn ʿAbbās, Mujāhid, Saʿīd bin Jubayr, ʿIkrimah, Qatādah); al-Ḥasan and Qatādah on the wealth; the boast's own grammar; Mujāhid on "anyone"; the lips' three jobs; Ibn Masʿūd's chain on the two ways; Ibn Zayd on the pass; the manumission chain + Muṭarrif + Aḥmad's wider list; saghb = hunger; the doubled kinship gift (Salmān bin ʿĀmir); Ibn ʿAbbās on dhā matrabah + 9:60; 17:19/16:97 + the three mercy reports; the ten glosses on muʾṣadah. All 20 verses ≥2 H2. Closes sūrah 90. | `cea6540` |
| 91 (batch AV) | 91:1–91:15 + Introduction (no SKIPs, all 15 verses touched) | 19 insertions + 3 new H2s (intro Where the Sūrah Was Heard; v9 The Prayer He Made at These Verses; v15 A Variant in the Opening Letter, and Who Fears Nothing) + 16 repairs (15 after-header blanks, 1 dangling quote at 91:2); 5 refs touched (87:1, 92:1, 92:2, 51:47, 30:30), all verbatim. Evidence: the Jābir/Muʿādh report on reciting this sūrah in ʿIshāʾ (Two Ṣaḥīḥs, placed in the Introduction per R1.3); ḍuḥā glosses + Ibn Jarīr's verdict; the crescent glosses (Mujāhid, al-ʿAwfī/Ibn ʿAbbās, Qatādah); Mujāhid's link to 92:2; the covering gloss; Qatādah vs Mujāhid on the heaven's construction; the ṭaḥāhā roster; the two fiṭrah reports (Bukhārī/Muslim, ʿIyāḍ bin Ḥimār); the decree reports with the Prophet ﷺ reciting 91:7–8 as his proof (al-Bukhārī from ʿAlī, Aḥmad, at-Tirmidhī ḥasan ṣaḥīḥ, Muslim); Qatādah/ʿIkrimah/Saʿīd bin Jubayr/Ibn Zayd on inspiration; aṭ-Ṭabarānī's pause and Zayd bin Arqam's duʿāʾ; the process gloss on burying the soul; Qudār's standing + the collector list + Qatādah's pledge of the whole tribe; fa-sawwāhā as an even punishment; the wāw/fāʾ variant and the glosses on "consequence". All 15 verses ≥2 H2. Closes sūrah 91. | `e638e60` |
| 92 (batch AW) | 92:1–92:21 (SKIP 1, 2, 15, IK gloss is paraphrase of what the section already carries) | 19 insertions + 3 new H2s (v8 In No Need of His Lord; v13 Both Realms Under One Owner; v16 The Refusal Named as a Refusal) + 21 repairs (21 after-header blanks); 4 refs touched (78:8, 51:49, 6:110, 16:9), all verbatim. Evidence: the pairs verses behind the third oath; the opposites-parallel behind "your striving is diverse"; the Baqīʿ al-Gharqad scene in full with the Prophet ﷺ reciting 92:5–10, plus the Abū Bakr, ʿUmar and Jābir/Surāqah accounts; Qatādah and Khusayf on al-ḥusnā; Ibn ʿAbbās on the way of ease + ʿĀmir bin ʿAbdullāh's occasion report; ʿIkrimah/Ibn ʿAbbās on false self-sufficiency; the denial glossed as the recompense; 6:110 on the facilitated turn; Mujāhid vs Zayd bin Aslam on the descent; Qatādah on the undertaking + 16:9; the ownership gloss; an-Nuʿmān bin Bashir's sermon (Aḥmad, Simāk bin Ḥarb) and the lightest-punishment report (Bukhārī/Muslim); denial-in-heart vs turning-away-in-limbs + the "except whoever refuses" report; the Abū Bakr attribution with its stated limits; the three objects of purification; ʿUrwah bin Masʿūd at Ḥudaybiyyah; the vision gloss; the two-riding-animals report. All 21 verses ≥2 H2. Closes sūrah 92. | `570cb2b` |
| 93 (batch AX) | 93:1–93:11 (SKIP 1, 7, already covered equally well) | 9 insertions + 11 repairs (11 after-header blanks); 0 new refs. Evidence: the named sajā glosses and the proof-of-power reading; the full transmission of the occasion (Aḥmad, al-Bukhārī, Muslim, at-Tirmidhī, an-Nasāʾī, Ibn Abī Ḥātim, Ibn Jarīr; Jundub bin ʿAbdullāh al-Bajalī al-ʿAlaqī; al-Aswad bin Qays; al-ʿAwfī from Ibn ʿAbbās on the two-halved taunt); the straw-mat report (Aḥmad from Ibn Masʿūd, at-Tirmidhī ḥasan ṣaḥīḥ) and the choice at the end of his life; the al-Awzāʿī/Ibn ʿAbbās showing and al-Kawthar; the sequence of shelters from Āmina to the Anṣār; the two positions combined + the richness-of-soul and contentment reports; Qatādah's merciful-father gloss; Ibn Isḥāq and Qatādah on the asker; the two thankfulness reports (Abū Dāwūd, at-Tirmidhī ṣaḥīḥ). All 11 verses ≥2 H2. Closes sūrah 93. | `de5b499` |
| 94 (batch AY) | 94:1–94:8 (SKIP 2, 5, already covered equally well) | 6 insertions + 8 repairs (8 after-header blanks); 0 new refs. Evidence: the illuminated-and-widened gloss with the law-made-easy corollary; al-inqiḍ and the Salaf gloss; Mujāhid's and Qatādah's glosses on the raised renown; the reaffirmation-by-repetition reading; the worship gloss with Mujāhid's line and the two agreed reports on prayer and dinner; the intention-and-desire gloss closing the pair. All 8 verses ≥2 H2. Closes sūrah 94 and the 90–94 assignment. | `831ecbe` |
