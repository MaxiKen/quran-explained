...
| 68 (batch AU) | 68:1–68:50 (SKIP 7, 12, 21, 22, 41, already covered equally well) | 49 insertions + 48 new H2s + 97 repairs (49 after-header blanks, 48 dash blanks); 14 refs touched (quoted: 11:108, 54:26, 34:24, 74:11, 74:12, 74:13, 74:24, 74:26, 68:28, 6:44; bare: 68:17, 37:143–144, 52:40, 3:77), all verbatim. Highlights: three readings of "what they write" (Ibn ʿAbbās/Mujāhid/Qatādah, as-Suddī, the decree-pen) + the pen-ḥadīth chains (Ibn Abī Ḥātim, Aḥmad, Tirmidhī ḥasan ṣaḥīḥ gharīb); the earliest gloss on *khuluq ʿaẓīm* as "a great religion, and it is Islam" (Ibn ʿAbbās via al-ʿAwfī + six authorities); the Saʿd ibn Hishām question chain (Qatādah, ʿAbd ar-Razzāq, Muslim); Anas's ten years (Two Ṣaḥīḥs), al-Barāʾ (Bukhārī), ʿĀʾishah (Aḥmad); the two-graves report and Ḥudhayfah on *namīmah*; al-Ḥārithah ibn Wahb's ʿutull report (Two Ṣaḥīḥs) and al-Bukhārī from Ibn ʿAbbās on *zanīm*; the 74:11–26 parallel for the "ancient fables" charge; Ibn Jarīr's reading of the branding; the Darawān / Ethiopian backstory of the garden and the father's practice; *tusabbihūn* = "if Allah wills" (Mujāhid, as-Suddī, Ibn Jurayj, Ibn Jarīr) with the *awsat* roster; Abū Saʿīd al-Khudrī's report behind the bared Shin; the 6:44 gate-opening; the *makẓūm* glosses and "I am not better than Yūnus ibn Mattā". All 50 verses ≥2 H2. | `1d4183a` |
| 68 (batch AV) | 68:51–68:52 (no SKIPs) | 5 insertions + 5 new H2s + 4 repairs (2 after-header blanks, 2 dash blanks); 1 ref touched (113:5), all verbatim. The sūrah's largest single gap: 68:51 read as proof that the eye's effect is real by Allah's command, with the Ibn ʿAbbās/Mujāhid glosses on *yuzliqūnaka* and the envy behind an attempt that did not land; the eye reports (Muslim from Ibn ʿAbbās "if anything were to overtake the divine decree"; Asmāʾ bint ʿUmays, Aḥmad/Tirmidhī ḥasan ṣaḥīḥ; Abū Hurayrah, Bukhārī + Muslim); the Sahl ibn Ḥunayf / ʿĀmir ibn Rabīʿah incident at Kharrar with the prescribed washing and "ask Allah to bless it"; the protection used (Ḥasan and Ḥusayn invocation, Bukhārī + Sunan; Abū Saʿīd on the Muʿawwidhatān, Tirmidhī ḥasan; ʿĀʾishah on ruqyah, Two Ṣaḥīḥs; Buraydah / ʿImrān ibn Ḥuṣayn, flagged as not raised to the Prophet ﷺ in the Bukhārī and Muslim versions); 68:52 the eyes and the tongue read as one attack. All 2 verses ≥2 H2. Closes sūrah 68. | `4e26e89` |
| 69 (batch AW) | 69:1–69:50 (SKIP 2, 3, 15, 21, 25, already covered equally well) | 66 insertions across 45 verses + 66 new H2s + 98 blank-line repairs (49 verse-header blanks and 49 post-separator blanks removed; all 134 headings now blank-delimited on both sides); 16 refs touched (quoted: 91:11, 41:16, 26:105, 78:19, 2:46, 81:19–21, 81:22, 81:24, 81:25, 41:44, 34:54, 26:200; bare: 69:37, 43:12–13, 36:41–42, 69:35), all verbatim, 0 lost. Highlights: the three readings of *al-ṭāghiyah* — Qatādah's Cry against Mujāhid's, ar-Rabīʿ ibn Anas's and Ibn Zayd's sins — with Ibn Zayd's supporting citation of 91:11; *sakhkharahā* as subjugation set beside *sakhkhara* at 41:16, and *ḥusūm* as unbroken succession with ʿIkrimah's and ar-Rabīʿ ibn Khuthaym's second sense of calamity; no remnant of ʿĀd and none of those before Pharaoh, and the *rābiyah* of the overflow; the Deluge as a test of hearts, the three glosses on *udhunun wāʿiyah* (Ibn ʿAbbās, Qatādah, ad-Daḥḥāk) and the Ark promised as a lasting reminder, set beside 43:12–13 and 36:41–42; the single blast, the levelling of the earth, Ibn Jurayj's comparison of the torn sky to 78:19 with Ibn ʿAbbās on the Throne drawn near, the eight bearers, and the day on which no secret stays hidden; the record in the right hand — ʿAbd ar-Raḥmān ibn Zayd's gloss on *hāʾum iqraʾū kitābiyah*, the hundred levels of the Garden, and the report that no one enters by his deeds; the five sentences of the left hand, *al-qāḍiyah* as a death followed by no life (ad-Daḥḥāk, Muḥammad ibn Kaʿb, ar-Rabīʿ, as-Suddī), Qatādah's note that he will wish for the thing he most feared, and wealth and authority failing together; the shackle, the seventy-cubit chain measured three ways (Kaʿb al-Aḥbār; al-ʿAwfī from Ibn ʿAbbās and Ibn Jurayj; Ibn Jurayj's own report) with the depth report recorded by Imām Aḥmad from ʿAbdullāh ibn ʿAmr and by at-Tirmidhī; the two rights he did not establish, no friend whose word is taken, *ghislīn* glossed four ways, and the *khāṭiʾūn* named at both ends of the sūrah; the double oath by the seen and the unseen, the noble messenger identified, the two refusals of poetry and soothsaying measured against 81:19–25, the forging condition of 69:44–47, and *al-watīn* as the aorta. All 50 verses ≥2 H2 (was 24 below two and 16 with none; now min 2, max 5). | `1ef5b3d` |
| 69 (batch AX) | 69:51–69:52 (no SKIPs) | 3 insertions + 3 new H2s (v51 What *Ḥaqq al-Yaqīn* Names, and The Word the Sūrah Opened With; v52 The One Who Sent It Down) + 5 repairs (2 verse-header blanks, 2 separator blanks, 1 trailing double blank at EOF); 0 refs touched. *Ḥaqq al-yaqīn* glossed as the right and truthful report in which there is no doubt, no suspicion and no confusion — the highest of the Book's ranks of knowing, and the same root the sūrah opened with, so that the question at its head and the statement at its end are about one thing; the closing command to glorify the Name of the Lord read as attached to what precedes it, praise directed at the sending down the sūrah has just argued for and addressed to the man who carried the message rather than to those who refused it. All 2 verses ≥2 H2 (v51 was 0, v52 was 1). Closes sūrah 69. | `c77ed10` |
