...
| 114 (batch AU) | 114:1–114:6 (single batch; all six verses considered, no SKIPs) | All six IK records are byte-identical (one shared block), so each piece of evidence was placed once, at the verse it concerns. 14 paragraphs + 5 new H2s (v1 *Refuge Is Taken With All Three Titles, Not One*; v4 *Every Person Has One Assigned* and *Perched on the Heart, and Two Ways He Withdraws*; v5 *A Man Frightened by His Own Thoughts*; v6 *What the Last Phrase Explains*) + 10 repairs (5 after-header blanks, 5 dash blanks). Evidence: v1 the three titles are attributes of God and universal in themselves (Lord, King and God of everything; created, owned and answerable to Him), so the narrowing to *an-nās* sits in the request, and refuge is taken with the One who holds all three rather than distributed among them; v2 *malik* as the middle term of that chain — a human king rules what he neither made nor owns; v3 the chain ends in service, *ʿabd* and *ilāh* being the two halves of one relation; v4 the whisperer is the *qarīn* assigned to every person, with the report Ibn Kathīr cites only as "confirmed in the Ṣaḥīḥ" (the source gives no collection or narrator, so none was supplied), plus Ibn ʿAbbās through Saʿīd bin Jubayr — and Mujāhid and Qatādah — on the devil perched upon the heart, al-Muʿtamir bin Sulaymān from his father (sad and happy alike), and al-ʿAwfī from Ibn ʿAbbās (he withdraws when he is obeyed); v5 the blood report restored to the Two Ṣaḥīḥs on Anas's authority with the Prophet's stated fear put back, plus Imam Aḥmad from Ibn ʿAbbās (also Abū Dāwūd and al-Nasāʾī) on the man who would rather fall from the sky than say aloud what he says to himself; v6 Ibn Jarīr named as the author of the *rijāl min al-jinn* argument, and the two readings of *min al-jinnati wa-l-nās* (who is whispered to / who does the whispering, the second like 6:112). 3 refs touched (114:1, 72:6, 6:112), all verbatim. All 6 verses ≥2 H2. Closes sūrah 114, and the Qur'an. | `dae3eb5` |
