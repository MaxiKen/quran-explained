...
| 56 (batch AU) | 56:1–56:50 (SKIP 8, 9, 11, 16, 25, 31, 41, 45, 47, 48, already covered or no named report) | 40 insertions + 61 repairs (50 after-header blanks; 11 text: the two editor scratch-notes left inside the prose at v12 and v14 — both citation counts kept, both 34:13 wordings made verbatim — ṭalʿ→ṭalḥ ×3 at v29, ṣabāʿ/ṣamūm→samūm at v42, the negated adjectives at v44 corrected to barīd/karīm ×3, garbled verb forms at v46 ×2); 16 refs touched (69:15, 42:47, 70:1-2, 22:1, 73:14, 35:32, 3:133, 56:39-40, 11:78, 37:49, 88:11, 14:23, 2:25, 77:30, 11:104, 99:1), all verbatim. Evidence: the five sūrahs that greyed the Prophet ﷺ (Tirmidhī, ḥasan gharīb) + the 69:15 name-gloss (v1); Muḥammad bin Kaʿb and Qatādah on kadhibah + 42:47/70:1-2 (v2); the near-and-far hearing and the mighty/weak lowering (ʿAwfī–Ibn ʿAbbās, ʿIkrimah, Ḥasan, Qatādah, v3); ar-Rabīʿ bin Anas's sifter + 22:1 (v4); Ibn Zayd and 73:14 (v5); four dust glosses incl. ʿAlī's dust-storm (v6); Ādam's two sides, as-Suddī's majority and 35:32 (v7); the prophets/ʿilliyyīn readings + 3:133 (v10); the awwalūn debate (Mujāhid, Ḥasan, Ibn Jarīr and the objection against him, v13); the Abū Hurayrah occasion, the quarter/third/half and the seventy thousand (v14); the woven-with-gold roster (v15); servants who never change (v17); handles, spouts and the spring that does not empty (v18); Ibn ʿAbbās's four effects of wine (v19); choice read as a permission + Anas's turning plate (Aḥmad and Abū Yaʿlā, graded by aḍ-Ḍiyāʾ, v20); the Bukhtī-camel birds and Abū Bakr's exchange (Aḥmad, v21); Abū ʿUbaydah and al-Akhfash on the antecedent (v22); 37:49 (v23); the deeds named after the reward (v24); 14:23 and 88:11 (v26); Maymūn bin Mihrān on rank (v27); thornless and laden, with the roster (v28); ʿUtbah's seventy colours, the ṭalḥ/banana roster and Ibn Zayd's Yemen (v29); the hundred-year shade the Prophet ﷺ recited this verse for (Bukhārī, Muslim, v30); 2:25, ʿUtbah's Ṭūbā, Sidrat al-Muntahā and the eclipse cluster (v32); Qatādah on the fruit that replaces itself (v33); high, soft and comfortable (v34); brought back after age (v35); the strength reports (Ṭayālisī and Tirmidhī, ṣaḥīḥ gharīb; Ṭabarānī, judged by al-Maqdisī, v36); the ʿurub and atrāb glosses incl. thirty-three (v37); Ibn Jarīr's dedication (v38); the first company described (Bukhārī, Muslim, v39); Ibn Masʿūd's night of the prophets shown, ʿUkkāshah, and the seventy thousand defined (v40); the samūm/hamīm/yaḥmūm glosses (v42); 77:30 (v43); the karīm glosses (v44); shirk named and no intent to repent (v46); no one left out + 11:104 (v49); neither early nor late (v50). All 50 verses ≥2 H2. | `de7374d` |
| 56 (batch AV) | 56:51–56:96 (SKIP 51–54, 58, 64, 67, 69, 71, 74, 77, 83, 85, 95, already covered or no named report) | 33 insertions + 1 heading split (v75 The Lām Before the Oath) + 55 repairs (46 after-header blanks; 7 text: an Arabic letter left inside a transliteration and a headless sentence at v59, a stray period and a dash-fragment at v60, nuṭub→nuzul at v56, ʿarfaj/marakh→al-markh/al-ʿafār at v72, an unfinished clause at v76; 2 batch-boundary junctions where the ---/## Verse newline had been dropped, one of them dropped by batch AU's own splice and found here); 9 refs touched (16:10, 16:11, 18:107, 19:67, 26:210, 30:27, 41:30, 56:63-64, 75:40), all verbatim. Evidence: as-Suddī's thirst-disease (v55); one hospitality-word for both estates, 18:107 (v56); created after you were nothing + 30:27/19:67 (v57); stage after stage in the womb (v59); ad-Ḍaḥḥāk on equality in death (v60); shapes with no name yet (v61); hearing, sight and hearts + 75:40 (v62); "do not say zaraʿtu, say ḥarathtu" (Ibn Jarīr from Abū Hurayrah, v63); al-Kisāʾī's contrary word and the intact seed as mercy (v65); the mughramūn readings (v66); 16:10 (v68); salty, sour and undrinkable + 16:11 (v70); al-markh and al-ʿafār (v72); the one-part-in-seventy fire (Qatādah's mursal in Aḥmad; Mālik, al-Bukhārī, Muslim) and the al-muqwīn roster (v73); the mawāqiʿ glosses and ʿĀʾishah's lām (v75); the vow measures the thing sworn (v76); the Book that is in heaven (v78); the pure-ones roster, Qatādah's two worlds, Ibn Masʿūd's recitation, Abū al-ʿĀliyah and Ibn Zayd + 26:210 (v79); not magic, sorcery or poetry (v80); the mudhīnūn readings (v81); the rain-and-star report (ṣaḥīḥ to Ibn ʿAbbās) with Zayd bin Khālid at al-Ḥudaybiyyah (Muwaṭṭaʾ, Two Ṣaḥīḥs, Abū Dāwūd, Nasāʾī) and al-Ḥasan's saying (v82); watching the stupor (v84); the madīn readings (v86); back to the body as it was (v87); the near defined, Muḥammad bin Kaʿb on the moment of death, al-Barāʾ's angels (v88); the rawḥ/rayḥān roster and Abū al-ʿĀliyah's branch (v89); below the rank of the near (v90); ʿIkrimah's greeting + 41:30 (v91); ʿAbd ar-Raḥmān bin Abī Laylā on liking to meet God (Aḥmad; ʿĀʾishah in the Ṣaḥīḥ, v92); the guest whose drink dissolves him (v93); engulfed from every direction (v94); the two doxology reports (Jābir in Tirmidhī and Nasāʾī, ḥasan gharīb; al-Bukhārī from Abū Hurayrah, v96). All 46 verses ≥2 H2. Payload rebuilt and sw.js bumped to v2.5.28 in `739112e`. Closes sūrah 56. | `314aaad` |
