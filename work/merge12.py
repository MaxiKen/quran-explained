#!/usr/bin/env python3
"""Batch 12 merge: group files -> chapter_2_verse_221_240.md with QC validations."""
import json, re, sys

START, END = 221, 240
GROUPS = [
    "work/group_221_225.md",
    "work/group_226_230.md",
    "work/group_231_235.md",
    "work/group_236_240.md",
]
REFS = "work/references_221_240.md"
OUT = "chapter_2_verse_221_240.md"
...
banned = [
    ...
    "<!--", "RUN 13", "Source:", "Research notes", "TODO", "TBD",
]
for b in banned:
    if b in full:
