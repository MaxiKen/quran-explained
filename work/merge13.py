#!/usr/bin/env python3
"""Batch 13 merge: group files -> chapter_2_verse_241_260.md with QC validations."""
import json, re, sys

START, END = 241, 260
GROUPS = [
    "work/group_241_245.md",
    "work/group_246_250.md",
    "work/group_251_255.md",
    "work/group_256_260.md",
]
REFS = "work/references_241_260.md"
OUT = "chapter_2_verse_241_260.md"
...
banned = [
    ...
    "<!--", "RUN 14", "Source:", "Research notes", "TODO", "TBD",
]
for b in banned:
    if b in full:
