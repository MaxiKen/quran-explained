#!/usr/bin/env python3
"""Batch 23 (Chapter 3 batch 7) merge: group files -> chapter_3_verse_121_140.md with QC validations."""
...
OUT = "chapter_3_verse_121_140.md"
...
banned = [
    ...
    "<!--", "RUN 19", "RUN 20", "RUN 21", "RUN 22", "RUN 23", "Source:", "Research notes", "TODO", "TBD",
