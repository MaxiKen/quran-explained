#!/usr/bin/env python3
"""Batch 21 (Chapter 3 batch 5) merge: group files -> chapter_3_verse_81_100.md with QC validations."""
...
GROUPS = [
    ...
    "work/group_86_90.md",
    "work/group_91_95.md",
    "work/group_96_100.md",
]
REFS = "work/references_81_100.md"
OUT = "chapter_3_verse_81_100.md"
...
banned = [
    ...
    "<!--", "RUN 19", "RUN 20", "RUN 21", "Source:", "Research notes", "TODO", "TBD",
