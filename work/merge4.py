#!/usr/bin/env python3
"""Batch 4 merge: group files -> chapter_2_verse_61_80.md with QC validations."""
import json, re, sys
...
# 4. References last: last marker before ## References
