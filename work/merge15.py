#!/usr/bin/env python3
"""Batch 15 merge: group files -> chapter_2_verse_281_286.md with QC validations."""
import json, re, sys

START, END = 281, 286
GROUPS = [
    "work/group_281_285.md",
    "work/group_286_286.md",
]
REFS = "work/references_281_286.md"
OUT = "chapter_2_verse_281_286.md"
...
banned = [
    ...
    "<!--", "RUN 16", "Source:", "Research notes", "TODO", "TBD",
]
for b in banned:
    if b in full:
