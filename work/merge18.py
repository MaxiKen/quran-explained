#!/usr/bin/env python3
"""Batch 18 (Chapter 3 batch 2) merge: group files -> chapter_3_verse_21_40.md with QC validations."""
...
banned = [
    ...
    "<!--", "RUN 18", "Source:", "Research notes", "TODO", "TBD",
...
# 8. Depth floor: >= ~600 commentary words/verse (before references)
