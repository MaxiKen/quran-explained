#!/usr/bin/env python3
"""Batch 14 merge: group files -> chapter_2_verse_261_280.md with QC validations."""
import json, re, sys

START, END = 261, 280
GROUPS = [
    "work/group_261_265.md",
    "work/group_266_270.md",
    "work/group_271_275.md",
    "work/group_276_280.md",
]
REFS = "work/references_261_280.md"
OUT = "chapter_2_verse_261_280.md"
...
banned = [
    ...
    "<!--", "RUN 15", "Source:", "Research notes", "TODO", "TBD",
]
for b in banned:
    if b in full:
