...
## RUN 19 — CHAPTER 3, VERSES 21–40 (BATCH 2)

- Delivery file: `chapter_3_verse_21_40.md` (16,943 words; ~784 words/verse, avg 9.3 paragraphs/verse, min 633 — meets/ exceeds Chapter 2 ~725 w/v standard).
- Genuine 4-stage generation (user's standing requirement): `work/group_21_25.md` (3,344 w) → `work/group_26_30.md` (3,783 w) → `work/group_31_35.md` (3,567 w) → `work/group_36_40.md` (4,239 w), each written separately with only its 5 verses, then joined via `work/merge18.py` (PASS; includes depth floor >=600 w/verse + normalized-repeat audit).
- References: `work/references_21_40.md` (15 dash bullets; Ibn Kathir + Al-Jalalayn + Maududi via surahquran.com pages 21, 23, 26, 28, 29, 31, 33, 35, 37, 38).
- QC: 20 sequential headings 21–40; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers.
- Content highlights: 3:21–22 Jews killing prophets (43 prophets / 170 slain just men in the tradition) + voided deeds; 3:23–25 the Book as arbiter (stoning verdict occasion), "few days" doctrine, the exact gathering; 3:26–27 sovereignty du'a (transfer of prophecy to the final Prophet; night/day, living/dead, provision without measure); 3:28–30 loyalty/tuqyah exception (Abu ad-Darda; Al-Hasan), heart-knowledge, the Day of presented deeds, Ra'uf; 3:31–32 love test (Al-Hasan al-Basri; the rejection hadith) + obedience; 3:33–34 chosen families (Adam/Noah/Ibrahim/'Imran; Najran delegation, 9 A.H.); 3:35–40 Maryam's birth (Hannah bint Faqudh; naming hadiths; the refuge hadith — no newborn touched by Satan except Maryam and her son), guardianship via quills at the River Jordan, out-of-season fruits, Zakariyya's secret night prayer, and the good news of Yahya (sayyid, hasur = immune from unlawful, not celibate).

## RUN 20 — CHAPTER 3, VERSES 41–60 (BATCH 3)

- Delivery file: `chapter_3_verse_41_60.md` (16,750 words; ~776 words/verse, avg 9.3 paragraphs/verse, min 601).
- Genuine 4-stage generation: `work/group_41_45.md` (3,529 w) → `work/group_46_50.md` (4,189 w) → `work/group_51_55.md` (3,711 w) → `work/group_56_60.md` (3,273 w), each written separately with only its 5 verses, joined via `work/merge19.py` (PASS; depth floor >=600, normalized-repeat audit).
- References: `work/references_41_60.md` (12 dash bullets; Ibn Kathir + Al-Jalalayn via surahquran.com pages 38, 42, 45, 49, 52, 55, 59, 37; Maududi via page 33).
- QC: 20 sequential headings 41–60; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers.
- Content highlights: 3:41 Zakariyya's sign (three days of gesture-only speech, remembrance + glorification); 3:42–43 Maryam chosen above the women of the worlds (hadiths of Maryam/Khadijah, Maryam/Asiyah), qunut/sujud/ruku' instruction; 3:44 news of the unseen (the casting of quills at the River Jordan, 'Ikrimah's account); 3:45–48 good news of 'Isa — a Word from Him, honored in both worlds, among the nearest, cradle speech (Jurayj hadiths), virgin-birth "how" answered by "Be!", taught the Book, wisdom, Torah, Gospel; 3:49 the signs (bird from clay — the bat tradition; blind, leper, dead, household unseen; Al-Jalalayn's 50,000 healed; raised individuals), 3:50 confirmation of the Torah and the legalization of part of what was forbidden; 3:51–53 the Messiah's creed, the disciples' call (Hawari, Az-Zubayr hadith, pre-Hijrah parallel with the Ansar), the prayer "write us among the witnesses" (Ibn 'Abbas: the Ummah of Muhammad); 3:54 the plot and the substitution (image on a man in the house, crucifixion of the substitute); 3:55–57 the taking/raising (mutawaffika as sleep per Al-Hasan; 4:156–159), elevation of the followers until the Day, the two verdicts; 3:58–60 the wise reminder, the Adam/'Isa argument (the claim about Adam is obviously false, so the same claim about 'Isa is even more false), the truth from the Lord and the mubahalah framing.

## RUN 21 — CHAPTER 3, VERSES 61–80 (BATCH 4)

- Delivery file: `chapter_3_verse_61_80.md` (18,922 words; ~859 words/verse, avg 10.3 paragraphs/verse, min 627).
- Genuine 4-stage generation: `work/group_61_65.md` → `work/group_66_70.md` → `work/group_71_75.md` → `work/group_76_80.md`, each written separately with only its 5 verses, joined via `work/merge20.py` (PASS; depth floor >=600, normalized-repeat audit).
- References: `work/references_61_80.md` (15 dash bullets; Ibn Kathir + Al-Jalalayn + Maududi + Ibn 'Abbas via surahquran.com pages 61, 64, 67, 69, 73, 75, 77, 78, 79).
- QC: 20 sequential headings 61–80; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers.
- Content highlights: 3:61–63 the Mubahalah (the Najran delegation of sixty horsemen and fourteen chiefs; Al-'Aqib's counsel; the jizya treaty; Abu 'Ubaydah "the trustee of this Ummah"; the true narrative and the All-Aware of the corruptors); 3:64–66 the "common word" of Tawhid (the Heraclius letter; no lords besides Allah; the censure of disputing without knowledge); 3:67–68 Ibrahim the hanif and the true heirs (the best claim: followers, this Prophet, the believers; Ibn Mas'ud's Wali hadith); 3:69–74 the plots (Ka'b's invitation to Mu'adh, Hudhayfah, and 'Ammar; the morning-faith/evening-rejection fraud; the monopoly of revelation; "all bounty is in the Hand of Allah"); 3:75–76 the qintar/dinar trust doctrine ("no blame on us concerning the unlettered"; Ibn 'Abbas on dhimmah property; 'Abdullah bin Salam and Ka'b bin al-Ashraf; Deuteronomy/Talmud citations); 3:77 the sold covenant and false oaths (Abu Dharr's three; Imru' al-Qays's Paradise; Al-Ash'ath's own case); 3:78 the twisted tongues (Wahb bin Munabbih; Maududi's 18:110 misreading example); 3:79–80 the rabbaniyyin and the refusal of prophet-worship (the Najran claim and the prostrate request; the Maududi/Jalalayn reading of rabbani).

## RUN 22 — CHAPTER 3, VERSES 81–100 (BATCH 5)

- Delivery file: `chapter_3_verse_81_100.md` (20,087 words; ~914 words/verse, avg 10.9 paragraphs/verse, min 605).
- Genuine 4-stage generation: `work/group_81_85.md` → `work/group_86_90.md` → `work/group_91_95.md` → `work/group_96_100.md`, each written separately with only its 5 verses, joined via `work/merge21.py` (PASS; depth floor >=600, normalized-repeat audit).
- References: `work/references_81_100.md` (13 dash bullets; Ibn Kathir + Al-Jalalayn + Maududi + Ibn 'Abbas via surahquran.com pages 81, 83, 85, 90, 92, 93, 96, 100).
- QC: 20 sequential headings 81–100; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers.
- Content highlights: 3:81–82 the covenant of the prophets ("Isri" = My covenant per Ibn 'Abbas/Mujahid/etc.; the pledge to believe in and support the coming Messenger; Muhammad as the Final Prophet, the greatest Imam, the intercessor of the Maqam al-Mahmud) and the turning-away as *fisq*; 3:83–85 the total submission willing/unwilling (the believer in heart and body, the disbeliever in body only), the inclusive creed of the believers (no distinction among the prophets), and "whoever seeks other than Islam — never accepted" (the hadith of the rejected deed); 3:86–91 the disbelievers after belief and clear proofs, the triple curse (Allah, angels, humanity), the eternal abiding, the open door of repentance (89) and the closed door for the increasing deniers (90 — the Bazzar Ibn 'Abbas report), the useless earth-full-of-gold ransom (the 'Abdullah bin Jud'an hadith; Anas's hadith of the man of the Fire); 3:92 the attainment of Al-Birr by spending from what one loves (Abu Talhah's Bayruha' garden; 'Umar's Khaybar waqf; Maududi's critique of legalistic "righteousness" as paint over worm-eaten wood); 3:93–95 the Jewish food objection (Isra'il's sciatica vow re camel meat/milk; the Torah's own abrogations — Noah's animals, Adam's children, Hajar, Ya'qub's two sisters; the four questions hadith with the pledge of Ya'qub; "bring the Torah and recite it"; the liars-of-Allah verdict; "Allah has spoken the truth, follow the religion of Ibrahim the Hanif"); 3:96–97 the first House at Bakkah (forty years before al-Aqsa per Abu Dharr; the names of Makkah; the Maqam and its 'Umar relocation; the sanctuary's security and prohibitions; the obligation of Hajj and its ability-provision; the denier as kafir — 'Umar's statement); 3:98–100 the two closing questions to the People of the Book (denial, obstruction) and the believers' warning against obeying them (the Aws/Khazraj occasion; 2:109's envy; the hadith of the most amazing faith — the later people who find only books).

## RUN 23 — CHAPTER 3, VERSES 101–120 (BATCH 6)

- Delivery file: `chapter_3_verse_101_120.md` (19,693 words; ~900 words/verse, avg 8 paragraphs/verse, min 615).
- Genuine 4-stage generation: `work/group_101_105.md` → `work/group_106_110.md` → `work/group_111_115.md` → `work/group_116_120.md`, each written separately with only its 5 verses, joined via `work/merge22.py` (PASS; depth floor >=600, normalized-repeat audit).
- References: `work/references_101_120.md` (15 dash bullets; Ibn Kathir + Al-Jalalayn + Ibn 'Abbas/Mujahid/Qatadah/Ad-Dahhak via surahquran.com pages 101, 103, 106, 110, 113, 116, 118, 119).
- QC: 20 sequential headings 101–120; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers; no title line; depth >=600/verse (avg 900); >=4 paragraphs/verse.
- Content highlights: 3:101 "How can you disbelieve" with the recitation and the Messenger, the hadith of the most amazing faith (the later people who find only books), *i'tisam* as the guidance; 3:102 Taqwa as His due (Ibn Mas'ud's obey/remember/appreciate; Anas's idle tongue; preserve Islam till death; Zaqqum-drop hadith; Jabir's "good opinion of Allah" and "I am as My servant thinks of Me"); 3:103 the rope of Allah (Al-Jalalayn: His religion), Aws/Khazraj united hearts, brink of the pit; 3:104 the group of callers (Ad-Dahhak: Jihad + scholars; Abu Hurayrah hand/tongue/heart; Hudhayfah's punishment if no enjoining); 3:105 division after proofs (Mu'awiyah via Abu 'Amir: 72/73 sects, one saved — the Jama'ah; madness like rabies); 3:106–107 white/black faces (Ibn 'Abbas — Sunnah white, Bid'ah black; Al-Hasan — hypocrites; Abu Umamah on the Khawarij heads; the rebuke and the eternal mercy); 3:108–109 the Ayat recited in truth; Allah wills no injustice — the Just Ruler who needs no wrong; all in heavens/earth are His; all matters return to Him; 3:110 the best Ummah ever raised (Abu Hurayrah "tied in chains"; 70 nations hadith; 'Ali's hadith; 70,000 moon-faced; 1/4→1/3→1/2 of Paradise; 120 rows/80 for this Ummah; Friday hadith; Qatadah on 'Umar's Hajj recitation — fulfill the condition); 3:111–112 no harm beyond annoyance, they flee unhelped; *dhillah* everywhere except the dhimmah (Jizyah covenant; Ibn 'Abbas, Mujahid), causes — kufr, killing prophets, disobedience/transgression; 3:113–115 not all alike — 'Abdullah bin Salam and companions (Ibn Ishaq; Al-'Awfi/Ibn 'Abbas), night recitation and prostration, faith/Last Day/enjoin/forbid/racing in good, never denied, Allah knows the Muttaqin; 3:116–117 wealth/children useless — residents of the Fire forever; the *sirr* (bitter wind — Ibn 'Abbas, 'Ikrimah, Sa'id bin Jubayr, Al-Hasan, Qatadah, Ad-Dahhak, Ar-Rabi'; also fire per Ibn 'Abbas/Mujahid) destroying the harvest of the self-wronged, Allah never wrongs them; 3:118–120 no *bitanah* outside (Abu Sa'id's two-advisors hadith; 'Umar refusing the Christian scribe of Hirah), the love/doubt imbalance, "we believe" said in meetings, fingertips bitten in rage, "May you die of your rage" (Al-Jalalayn: remain thus), Allah knows the hearts; 3:120 grief at good/joy at evil, patience + taqwa as the shield, Allah encompasses their deeds.

## RUN 24 — CHAPTER 3, VERSES 121–140 (BATCH 7)

- Delivery file: `chapter_3_verse_121_140.md` (18,801 words; ~842 words/verse, avg 7 paragraphs/verse, min 633).
- Genuine 4-stage generation: `work/group_121_125.md` → `work/group_126_130.md` → `work/group_131_135.md` → `work/group_136_140.md`, each written separately with only its 5 verses, joined via `work/merge23.py` (first run thin {131: 593, 132: 594} → expanded closing paragraphs in `work/group_131_135.md`; rerun PASS; depth floor >=600).
- References: `work/references_121_140.md` (17 dash bullets; Ibn Kathir + Al-Jalalayn + Maududi + Ibn 'Abbas/'Ali/Qatadah/As-Suddi/Ar-Rabi' via surahquran.com pages 121, 122, 124, 126, 128, 130, 133, 135, 137, 140).
- QC: 15 checks — 20 sequential headings 121–140; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs; no [n] leftovers; no title line; depth >=600/verse (avg 842); >=4 paragraphs/verse; sources present.
- Content highlights: 3:121–122 the battle of Uhud (Saturday, Shawwal, year 3; 1000/950 vs 3000; the reason — Abu Sufyan's caravan money and the Badr dead; the consultation and the Prophet's shield; 700 after Ibn Ubayy's retreat; the archers under 'Abdullah bin Jubayr; Banu Salimah/Banu Harithah about to cower — Allah their Wali, the tawakkul command); 3:123–125 Badr's victory of the weak, the Prophetic reassurance and the scholars' debate (Badr — Al-Hasan, Ash-Sha'bi, Ar-Rabi', Ibn Jarir, Kurz bin Jabir story, 8:9's 1,000 then 3,000 then 5,000; or Uhud — the condition of patience+Taqwa not met, no angel; 'Ali: white wool and marked horses), and the conditional 5,000 *musawwimin*; 3:126–127 the reinforcement as good news and heart-reassurance only, victory only from Allah (47:4-6), the purposes of Jihad — cut off a part, humiliate the rest, frustrated retreat; 3:128 "not for you the decision" (13:40, 2:272, 28:56; the qunut hadiths of Salim bin 'Abdullah, Abu Hurayrah, Anas; the wound and broken tooth; the later pardon of the cursed); 3:129 the sovereignty and the forgiveness/punishment by His will, Ghafur/Rahim; 3:130–132 the riba prohibition (Jahiliyyah practice — "pay now or interest", doubling year by year; Maududi's link: booty-greed caused Uhud's setback), the Fire prepared, obedience for mercy; 3:133–136 the hastening to forgiveness and the vast Paradise (the Firdaws hadith, the dome under the Throne, 57:21, the night/day counter-question of Abu Hurayrah), the four qualities — spending in ease/hardship, kazm al-ghayz (the strong one hadiths; the dose of rage; the forgiveness of the debtor; the three oaths), pardon (the Muhsinin), repentance without persistence (the repeated-sin hadith; Iblis cried), and the reward of forgiveness, Gardens, eternity; 3:137–140 the sunan of history and the wisdom of Uhud's losses (70 dead; previous nations' losses with the good end theirs; travel and see the deniers' end), the Qur'an as bayan/hudan/maw'izah, "do not weaken nor grieve — you are the upper hand" (the a'lawn), and the alternation of days — the parallel wound (Badr), the revealing of the true believers, the taking of martyrs, and Allah's dislike of the wrongdoers.

## RUN 25 — CHAPTER 3, VERSES 141–160 (BATCH 8)

- Delivery file: `chapter_3_verse_141_160.md` (23,289 words; ~1,031 words/verse, avg 8 paragraphs/verse, min 642).
- Genuine 4-stage generation: `work/group_141_145.md` → `work/group_146_150.md` → `work/group_151_155.md` → `work/group_156_160.md`, each written separately with only its 5 verses, joined via `work/merge24.py` (PASS first run; depth floor >=600, normalized-repeat audit).
- References: `work/references_141_160.md` (14 dash bullets; Ibn Kathir + Al-Jalalayn + Maududi/Maarif + Ibn 'Abbas/'Ali/Qatadah/Hasan/As-Suddi/Jabir/Al-Bara'/Anas/Abu Hurayrah/Abu Bakr via surahquran.com pages 142, 143, 144, 149, 152, 154, 155, 157, 159).
- QC: 15 checks — 20 sequential headings 141–160; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs (14 bullets); no [n] leftovers; no title line; depth >=600/verse (avg 1,031); >=4 paragraphs/verse; sources present.
- Content highlights: 3:141–143 the purposes of the alternation (the tamhis/purification of the believers — sins forgiven or grades raised; the mahq of the disbelievers — their aggression's destruction), the question of the test ("do you think you enter Paradise without the Jihad and patience being known"), and the rebuke of the wish — "you wished for martyrdom before you met it" ("Would that we had a day like Badr" — Al-Jalalayn) — seen with eyes open, so why retreat?; 3:144 the rumor of the Prophet's killing at Uhud (Shaytan's shout; Ibn Qami'ah's claim; the Muhajir/bleeding Ansar exchange — "defend your religion"; Al-Bayhaqi), Muhammad only a Messenger with messengers before him (Al-Jalalayn: not a worshipped being), the turners harm not Allah, and Abu Bakr's recitation at the Prophet's death ('A'ishah/Al-Bukhari — the kiss, "Allah will not combine two deaths on you"; Ibn 'Abbas — "whoever worshipped Muhammad, Muhammad is dead, but whoever worshipped Allah, Allah is alive"; 'Umar — "my feet could not hold me"); 3:145 the appointed term (35:11, 6:2; encourages the coward; Hujr bin 'Adi crossing the Euphrates), the two rewards (world/Hereafter; 42:20, 17:18-19), the grateful rewarded; 3:146–148 the Ribbiyyun (Ibn Ishaq: prophets killed, companions' resolve held; Ibn Mas'ud: thousands; Ibn 'Abbas/Mujahid/etc.: large bands; Al-Hasan: patient pious scholars), never weakened or gave in (Qatadah/Ar-Rabi': after their Prophet was killed; Ibn 'Abbas: not humiliated; As-Suddi/Ibn Zayd: no submission to the enemy), Allah loves the patient; the supplication (forgive sins/excesses, firm feet, victory) — the only statement kept repeating — and the reward: world's (victory, triumph, good end) and the Hereafter's excellent; 3:149–151 the prohibition of obeying the disbelievers (utter destruction in both lives), "Nay, Allah is your Mawla and the best Helper," the terror in the disbelievers' hearts for unauthorized shirk (Jabir's five: one month of fear, earth as Masjid/clean, booty, intercession, sent to all mankind), the Fire their abode; 3:152 the turn of Uhud (the promise fulfilled at the start — slaying with His permission; Fashiltum = lost courage (Ibn 'Abbas); the dispute and disobedience of the archers after the victory was shown; the world's booty-seekers vs. the Hereafter's station-holders — Ibn Jubayr and companions slain; the test and the pardon; Al-Bara' hadith — the archers' instruction, the fleeing women, "The booty, the booty!", Ibn Jubayr's refusal, 70 killed, Abu Sufyan's shouts and the divine answers, the mutilation comment; Zubayr — the back lines uncovered, "Muhammad has been killed"; 'Amrah bint 'Alqamah and the flag; Anas bin An-Nadr — "Paradise! I am smelling its aroma" — 80+ wounds, recognized by the sister); 3:153–155 the flight (tus'iduna = up the mountain; no side glance; "Come to me, O servants of Allah!"; distress upon distress; do not grieve for the escaped or the struck), the slumber of the believers (Abu Talhah — sword fell repeatedly; everyone's heads nodding — hasan sahih) vs. the hypocrites' evil thought of Allah (thought of ignorance; reached victory for the idolators; 48:12), "the affair belongs wholly to Allah," the concealed "if we had any part..." and the answer — even in your homes, the written killing emerges to its death beds (the decree inevitable), the test and purification of the breasts/hearts, Allah Knowing the breasts; 155 the fugitives slipped by Shaytan for their earnings (the disobeyed command) — yet pardoned — Ghafur, Halim; 3:156–160 the prohibition of the disbelievers' creed (the law kanu — if they had stayed; Allah makes it a cause of regret; Allah gives life and death; All-Seer), the weighing of the martyrdom (forgiveness and mercy better than the amassed wealth), the gathering to Allah with reward/punishment, 3:159 the mercy of the Prophet's leniency (9:128; Qatadah/Hasan; the severe = harsh words, harsh-hearted = hard heart; 'Abdullah bin 'Amr's reading of the previous Books), the pardon/istighfar/consultation command (Al-Jalalayn: win hearts, be emulated; Badr, Uhud, Khandaq — Sa'd bin 'Ubadah and Sa'd bin Mu'adh; Hudaybiyyah — Abu Bakr; Ifk — 'Ali and Usamah; "the one whose advice is sought is to be trusted" — hasan), the resolution then trust (Allah loves the mutawakkilin), and 160 the exclusivity of the divine help (if He helps, no overcomer; if He forsakes, no helper after Him; the believers' trust).

## RUN 26 — CHAPTER 3, VERSES 161–180 (BATCH 9)

- Delivery file: `chapter_3_verse_161_180.md` (20,494 words; ~1,024 words/verse, avg 7–11 paragraphs/verse, min 612).
- Genuine 4-stage generation: `work/group_161_165.md` → `work/group_166_170.md` → `work/group_171_175.md` → `work/group_176_180.md`, each written separately with only its 5 verses, joined via `work/merge25.py` (PASS first run; depth floor >=600, normalized-repeat audit).
- References: `work/references_161_180.md` (14 dash bullets; Ibn Kathir + Al-Jalalayn via surahquran.com pages 164, 165, 169, 172, 173, 176, 180).
- QC: 15 checks — 20 sequential headings 161–180; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs (14 bullets); no [n] leftovers; no title line; depth >=600/verse (avg 1,024, min 612); >=4 paragraphs/verse (min 7 actual); sources present.
- Content highlights: 3:161–163 the ghulul (prophet exonerated; red robe of Badr; Ibn 'Abbas/Mujahid/Al-Hasan; Abu Malik Al-Ashja'i — worst ghulul a yard of land; Abu Humayd As-Sa'idi — Ibn Al-Lutbiyyah's gift and the Minbar speech), the contrast of ridwan vs. sakhat and the darajat with Allah; 3:164 the great favor — messenger from among themselves (Al-Jalalayn: an Arab like them, not angel/non-Arab), reciting/purifying/teaching (Hikmah = Sunnah), before it manifest error (9:128 parallel); 3:165 the Uhud musibah vs. twice at Badr, 'Umar's report (ransom of Badr → 70 killed, broken tooth, smashed helmet, blood on face), archers' disobedience = min 'indi anfusikum, Allah qadir over everything; 3:166–168 divine permission and the two knowings — believers tested (patient, firm, unshaken), hypocrites called "come fight or defend," "if we had known" — nearer to disbelief, mouths vs. hearts, Allah a'lam bima yaktumun; the sitters-at-home "if they had listened to us" → "avert death from your own selves, if you are truthful"; 3:169–171 martyrs alive with their Lord, provided for — Muslim/Masruq green birds with lamps below the Throne, asked thrice, wish to return and be killed again; Ahmad/Anas — only the martyr wishes to return; Ahmad/Ibn 'Abbas — Uhud martyrs' souls in green birds, brothers' wish "lest they abstain from Jihad" and Allah's "I will convey to them for you"; rejoicing in grace/bounty and no fear/grief; 3:172–175 the wounded responders (Al-Jalalayn: Abu Sufyan's market-fair of Badr a year later), ihsan/taqwa → ajr 'azim; Nu'aym bin Mas'ud's report → increase of iman, "Allah is sufficient for us, and He is the best Disposer"; return with grace/bounty, no harm, ridwan, dhu fadlin 'azim; 175 "only Satan prompting fear of his allies — fear Me if believers"; 3:176–178 consolation of the Prophet (his eagerness for the people's benefit), the racings in kufr never harm Allah, the will to give them no share (23:55-56, 68:44, 9:85 parallels), trade of faith for disbelief, the respite only to increase sin, the 'adhab 'azim/muhin; 3:179 the distinguishing (khabith from tayyib — Mujahid: the day of Uhud; Qatadah: Jihad and Hijrah), no disclosure of the Unseen (72:26-27 — except the chosen Messenger), believe and fear → great reward; 3:180 the miserly (bukhl harms religion and world), the collar on the Day (Al-Bukhari/Abu Hurayrah — bald-headed poisonous snake "I am your wealth, I am your treasure"; Ahmad/'Abdullah — hasan sahih via At-Tirmidhi), the inheritance (57:7 trustees), Allah khabir.

## RUN 27 — CHAPTER 3, VERSES 181–200 (BATCH 10, FINAL CHAPTER 3 BATCH)

- Delivery file: `chapter_3_verse_181_200.md` (24,131 words; ~1,206 words/verse, avg 6–12 paragraphs/verse, min 605).
- Genuine 4-stage generation: `work/group_181_185.md` → `work/group_186_190.md` → `work/group_191_195.md` → `work/group_196_200.md`, each written separately with only its 5 verses, joined via `work/merge26.py` (PASS first run after deepening 3:182 to 605+; depth floor >=600, normalized-repeat audit).
- References: `work/references_181_200.md` (16 dash bullets; Ibn Kathir + Al-Jalalayn + Al-Muntakhab + Maududi + Ibn 'Abbas/Al-Hasan/Mujahid/etc. via surahquran.com pages 181, 183, 184, 185, 186, 187, 188, 190, 195, 196, 199, 200).
- QC: 13 checks — 20 sequential headings 181–200; 20 line-isolated markers; translations verbatim exactly once; refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs (16 bullets); no [n] leftovers; no title line; depth >=600/verse (avg 1,206); >=4 paragraphs/verse (min 6); sources present.
- Content highlights: 3:181–182 the Jewish claim "Allah is poor!" in response to 2:245 (Ibn 'Abbas via Sa'id bin Jubayr — Ibn Marduwyah/Ibn Abi Hatim), the writing of the words + slaying of prophets (variant readings naktubu/yuktabu, qatlahum/qatluhum, naqulu/yaqulu), "Taste the burning," addressed in reproach and disgrace, and the justice "for what your hands sent ahead — Allah never unjust to His servants"; 3:183–184 the offering consumed by fire (Ibn 'Abbas/Al-Hasan: covenant in their Books; Al-Jalalayn: the white fire; Maududi: Judges 6:20-1, 13:19-20, 2 Chron 7:1-2, Elijah and Ba'l, 1 Kings 18-19), Zachariah and John slain, the address to the living content with their forefathers' deeds, and the comfort — messengers before denied with Bayyinat, Zubur (scrolls of Abraham), and the luminous Book (Torah/Gospel) — "so be patient as they were"; 3:185 every soul tastes death (55:26–27; Allah alone Ever-Living; Jinn/mankind/angels/Throne-bearers die), full wages on the Day, success = moved away from Fire + admitted to Paradise (Abu Hurayrah whip-of-Paradise hadith), dunya = enjoyment of deception (87:16-17, 28:60, finger-in-ocean hadith); 3:186 testing in wealth/selves (Al-Jalalayn: zakat duties + damages; worship + calamities) and abuse from Ahl al-Kitab and mushrikin (insult, slander, flirting with women), patience + taqwa = determination of affairs; 3:187–188 the covenant to make the truth known and not conceal (Al-Jalalayn variant readings; scholars warned — bridle of fire hadith), "threw it behind their backs," small price of supremacy in knowledge, "how evil is their purchase"; Ibn 'Abbas: this ayah was about the People of the Scriptures (Marwan/Rafi' exchange); rejoicing in wrongdoing + loving praise for what was not done (two robes of falsehood hadith; false claim → decrease), no escape from punishment; 3:189 dominion and power; 3:190–194 the proofs of Tawhid for Ulu al-Albab (sky/earth marvels; alternation of night and day; 12:105-106 warning), remembrance in all states ('Imran bin Husayn hadith — pray standing/sitting/on side), deep reflection, "not created in vain — glory to You — save us from the Fire" (nafs 'A'ishah — the Prophet weeping at night, "Woe to he who recites it and does not contemplate it"; Ibn 'Abbas — the eleven units at Maymunah's), the disgrace of the Fire and no helpers for the wrongdoers, the heard caller (the Messenger — "Believe in your Lord" → "we believed"), forgiveness/expiation/death with Al-Abrar, "grant us what You promised by Your Messengers — disgrace us not — You never fail the promise"; the Prophet's practice to recite these ten ayat at night; 3:195 acceptance of their supplication — no work of a worker lost, male/female, "some of you from others" (Umm Salamah's question on hijrah — Sa'id bin Mansur; Al-Hakim: sahih by Bukhari criteria; first woman to migrate — Ansar), migrants/expelled/harmed in My cause/fought/killed — expiation + Gardens with rivers, reward from Allah, "with Allah is the finest reward"; 3:196–198 not deceived by disbelievers' movement in the land (Al-Jalalayn: revealed when Muslims said "look how comfortable they are while we struggle"), brief enjoyment then Hell — evil resting place (40:4, 10:69-70, 31:24, 86:17, 28:61), and for the muttaqin Gardens with rivers forever as nuzul (entertainment) from Allah — what is with Allah best for Al-Abrar (Abu Ad-Darda' — death is better for every believer/disbeliever); 3:199 some People of the Book truly believe (Abdullah bin Salam and companions, the Negus — Ja'far's recitation of Maryam cried by priests; funeral prayer led for An-Najashi), humble before Allah, do not sell the verses for a small price (do not hide the description of Muhammad's Ummah), reward with their Lord, swift in account (Mujahid; double reward 28:52-54; Abu Musa's three persons with double reward — Book-person believed in his Prophet and in me; Al-Hasan: double for faith before and in Muhammad; few Jews, many Christians 5:82-85); 3:200 the final command — patience, vying in patience (Al-Hasan: keep Islam in ease/hardship; endure against enemies), Ribat (Ibn 'Abbas/Sahl bin Hanif/Muhammad b. Ka'b: awaiting prayer after prayer; Abu Hurayrah hadith — perfect ablution under hardship, steps to masajid, awaiting prayer — "this is the Ribat" ×3; Sahl b. Sa'd: a day of Ribat better than the world; Salman: a day and a night better than a month's fast + qiyam; Fadalah: record not sealed for the one who dies in Ribat, growing work + safety from grave trial — hasan sahih; Ibn 'Abbas: two eyes — weeping from fear, guarding in Allah's cause; Abu Hurayrah: servant of Dinar/Dirham/Khamisah vs. holder of the horse's reins — unkempt head, dusty feet), and taqwa — that they may prosper (Al-Jalalayn: win Paradise, be delivered from the Fire; 'Umar's letter to Abu 'Ubaydah on Roman mobilization quoting 3:200).
- Chapter 3 now COMPLETE: 200/200 verses delivered across batches 1–10.

## RUN 28 — CHAPTER 4 (AN-NISA), VERSES 1–20 (BATCH 1)

- Delivery file: `chapter_4_verse_1_20.md` (20,526 words; ~819 words/verse, avg 6–9 paragraphs/verse, min 687 words/verse — meets/exceeds Chapter 2 ~725 w/v standard).
- Genuine 4-stage generation (user's standing requirement): `work/group_1_5.md` (4,216 w) → `work/group_6_10.md` (4,033 w) → `work/group_11_15.md` (4,203 w) → `work/group_16_20.md` (3,744 w), each written separately with only its 5 verses, then joined via `work/merge27.py` (PASS; includes depth floor >=600 w/verse + normalized-repeat audit).
- References: `work/references_1_20.md` (16 dash bullets; Ibn Kathir + Al-Jalalayn + Al-Muntakhab + Maududi + Ibn 'Abbas/Mujahid/Ad-Dahhak/etc. via surahquran.com pages 1, 3, 6, 10, 11, 12, 13, 15, 17, 19, 20).
- QC: 20 sequential headings 1–20; 20 line-isolated markers; translations verbatim exactly once (curly-quote-safe, generated from JSON); refs last; no banned strings; 20 unquoted "In simple terms"; dash-only refs (16 bullets); no [n] leftovers; no title line; depth >=600/verse (avg 819); >=4 paragraphs/verse (min 6); sources present.
- Translations: verbatim from user-supplied Chapter 4 text encoded in `chapter_4_translation.json` (commit b93f63b); section headings and [nnn] footnote markers stripped; verse 46's in-text `[Herd us!]`/`[Tend to us!]` glosses preserved (outside this batch).
- Content highlights: 4:1 universal address to humanity, creation from a single soul and its mate, the rib hadith (Bukhari/Muslim), *tasa'aluna bihi* + *arham* variant readings, Raqib; 4:2 protecting orphan property (guardian's bad-for-good substitutions — Sa'id bin Al-Musayyib, Az-Zuhri, An-Nakha'i, Ad-Dahhak, As-Suddi's sheep/dirham examples), mixing-and-devouring, "great sin" authorities; 4:3 the orphan-girl guardian context ('A'ishah; 4:127 supplement), permission of up to four (Ghilan bin Salamah hadith — "Choose any four"; collectors), ta'ulu = injustice, 4:129's impossibility of perfect justice, bondwomen; 4:4 Nihlah = obligatory dowry (Ibn 'Abbas, 'A'ishah, Muqatil, Qatadah, Ibn Jurayj, Ibn Zayd), voluntary waiver (tiba nafs) with clear conscience; 4:5 al-sufaha' (children/women/orphans per Ibn 'Abbas, Mujahid, others; Al-Jalalayn's youth/insanity/bankruptcy), wealth as qiwam/support, feed/clothe + qawlan ma'rufan; 4:6 testing orphans until marriageable age (al-Shafi'i: fifteen), rushd, waste-and-haste, rich guardian abstains / poor takes reasonable, witnesses at hand-over, Allah the vigilant Reckoner; 4:7 the abolition of pre-Islamic male-only inheritance (Sa'id bin Jubayr, Qatadah), Umm Kujjah hadith (Ibn Marduwyah), Sa'd bin Ar-Rabi' daughters (Maududi/Al-Sabuni), obligatory shares (nasiban mafrudan); 4:8 non-inheriting kin/orphans/needy at division — Ibn 'Abbas: not abrogated; Mujahid/Ibn Mas'ud/Abu Musa/Al-Hasan etc.: obligatory; "kindness, charity, compassion and mercy"; 4:9 the dying man's harmful will ('Ali bin Abi Talhah/Ibn 'Abbas), Sa'd bin Abi Waqqas one-third hadith (Two Sahihs) — "leave your inheritors wealthy," qawlan sadidan; 4:10 eating fire into bellies — Abu Hurayrah's seven destructive sins (Two Sahihs), yaslawna/yuslawna readings; 4:11 the Fara'id foundation (Ibn 'Uyaynah: half of knowledge), Jabir's father hadith (Muslim/An-Nasa'i — noted by Ibn Kathir to relate to 4:176), Sa'd bin Ar-Rabi' case (Ahmad/Abu Dawud/At-Tirmidhi/Ibn Majah — two-thirds, one-eighth), male double share rationale, Ibn 'Abbas on pre-Islamic custom, one-daughter half, parents' sixths, mother's third/sixth with siblings, debts before bequests before shares; 4:12 spouse shares (husband half/quarter; wife quarter/eighth), kalalah = no parents nor children (Ibn Mas'ud's reading; maternal siblings), "without harm" = no bequest beyond third (Al-Jalalayn), consensus on debts-first, grandchild like child, Sunni impediments (murder, religion, slavery); 4:13 hudud as Allah's limits, obedience = no tricks/plots but each heir's appointed share, Gardens with rivers, eternal, al-fawz al-'azim; 4:14 disobedience + exceeding limits → eternal Fire, muhin (also narrators' variant yudkhilhu/nudkhilhu), the 70-year good deeds doomed by an unjust will hadith (Imam Ahmad/Abu Hurayrah; Abu Dawud sixty-year version; At-Tirmidhi Hasan Gharib); 4:15 interim confinement ruling, four witnesses, not abrogated per Ibn 'Abbas/'Ikrimah/Sa'id bin Jubayr/Al-Hasan/Qatadah (agreed), 'Ubadah bin As-Samit hadith — married = 100 lashes + stoning, unmarried = 100 lashes + banishment (Muslim; At-Tirmidhi Hasan Sahih); 4:16 the dual form, Mujahid's people-of-Lut reading vs. man-woman case, cursing/shaming/sandal-beating (Ibn 'Abbas, Sa'id bin Jubayr), abrogation by flogging/stoning; tawba + islah → fa'ridu 'anhema, Tawwab/Rahim; 4:17 every sin committed in ignorance (Mujahid, Abu Al-'Aliyah, Companions' saying; Ibn 'Abbas — "because of one's ignorance he commits the error"), "soon after" = before the angel of death (Ibn 'Abbas), everything before death (Ad-Dahhak; 'Ikrimah), last breath (Al-Hasan), Ibn 'Umar hadith — "as long as the soul does not reach the throat" (Imam Ahmad; At-Tirmidhi Hasan Gharib; Ibn Majah's narrator error noted); 4:18 deathbed repentance rejected (40:84; 6:158; sun rising from the west), those who die as disbelievers, "We have prepared a painful punishment"; 4:19 abolished inheritance of women per Ibn 'Abbas (Al-Bukhari) — marry/give in marriage/prevent marriage; no mistreatment to reclaim dowry (khul' context); fahishah = adultery (Ibn Mas'ud/Ibn 'Abbas/Sa'id bin Al-Musayyib/Ash-Sha'bi/Al-Hasan/b. Sirin etc.) or disobedience (Ibn 'Abbas, 'Ikrimah, Ad-Dahhak), Ibn Jarir's general reading; "live with them honorably" (2:228; the Prophet — best to family); "you may hate something Allah turns into great blessing" (Al-Jalalayn: righteous child); 4:20 replacing a wife — qintar = enormous gold dowry, not a bit taken back, interrogative as rebuke/disavowal (Al-Jalalayn), buhtanan (calumny) + ithman (manifest sin) as circumstantial qualifiers.
- Chapter 4 batch 1 COMPLETE: 20/20 verses. Next batch: 4:21–40 when requested.

## RUN 29 — CHAPTER 4 (AN-NISA), VERSES 21–40 (BATCH 2)

- Delivery file: `chapter_4_verse_21_40.md` (21,142 words; ~834 words/verse, avg 6–8 paragraphs/verse, min 602 words/verse — meets/exceeds Chapter 2 ~725 w/v standard).
- Genuine 4-stage generation (user's standing requirement): `work/group_21_25.md` (4,465 w) → `work/group_26_30.md` (3,649 w) → `work/group_31_35.md` (4,119 w) → `work/group_36_40.md` (4,189 w), each written separately with only its 5 verses, then joined via `work/merge28.py` (PASS first run; depth floor >=600 w/verse + normalized-repeat audit).
- References: `work/references_21_40.md` (16 dash bullets; Ibn Kathir + Al-Jalalayn + Al-Muntakhab + Maududi + Ma'arif + Ibn 'Abbas via surahquran.com pages 21, 22, 23, 24, 25, 26, 29, 31, 32, 33, 34, 35, 36, 37, 38, 40).
- QC: 20 sequential headings 21–40; 20 line-isolated markers; translations verbatim exactly once (curly-quote-safe, generated from JSON); refs last (16 dash bullets); no banned strings; 20 unquoted "In simple terms"; no [n] leftovers; no H1 title line; depth >=600/verse (avg 834); >=4 paragraphs/verse (min 6); no normalized repeats.
- Content highlights: 4:21 the unreturnable dowry — "privily with the other" validates the mahr, the mithaq ghaliz (solemn covenant), "retained honourably or set free virtuously" (Al-Jalalayn), vows pledged before Allah (Al-Muntakhab); 4:22 the father's former wives — ma = "man" (Al-Jalalayn), deceased or divorced, past forgiven, fahishah + maqt (severe hate from God) + evil way; 4:23 the forbidden degrees — Ibn 'Abbas' "seven by blood, seven by marriage," grandmothers/grandchildren, five-suckle rule within two years ('A'ishah's ten-then-five report, Muslim; Sahlah bint Suhayl), foster-relationship hadiths (Bukhari/Muslim), mother-in-law banned from contract (Al-Hasan b. Muhammad, Tawus, Ibrahim, Az-Zuhri, Makhul — consensus), stepdaughter banned after consummation (majority; Umm Habibah/Thuwaybah hadith), wives of biological sons (33:37 Zayd case; 33:4/33:40), two sisters and the Sunna's aunt extension; 4:24 married women banned except captives — Abu Sa'id Al-Khudri Awtas hadith (Imam Ahmad; At-Tirmidhi/An-Nasa'i/Ibn Jarir/Muslim), kitabat 'llah, wa-uhilla/wa-ahalla, muhsinin ghayra musafihin, ujur as fariḍah, mutual grace after the obligation; 4:25 slave-girl marriage concession — tawl (means), Al-Shafi'i's condition, outward faith suffices, owner's permission ("slave who marries without permission is a fornicator"; "only the adulteress gives herself in marriage"), muhsanat ghayr musafihat wa-la muttakhidhat akhdan (Ibn 'Abbas' whore/boyfriend definitions), half-punishment = 50 lashes + half-year banishment, no stoning (Maududi's answering of the Khawarij error; muhsanat's two senses), li-man khashiya al-'anat, patience better lest the child be enslaved; 4:26–28 the law's purposes — clarity, the sunan of those before (Ibn Kathir: righteous ways; Maududi: lasting prophetic principles vs. Jahiliyah), divine turning; the followers of shahawat (Jews, Christians, adulterers — Ibn Kathir) wish a tremendous deviation; takhfif (lightening) — the slave-girl concession as its example, khuliqa al-insan da'ifan (Tawus: concerning women; Waki': mind leaves with women), maqasid-legal consequences; 4:29–30 bāṭil wealth (Al-Jalalayn usury/usurpation; Al-Muntakhab's vice list; Ibn Kathir's legal-looking methods), tarāḍ with the option-to-part hadith (Two Sahihs), Ibn 'Abbas' food-scruple occasion → 24:61, "do not kill yourselves" — Abu Hurayrah suicide hadiths (iron/poison/mountain, Two Sahihs), Thabit b. Ad-Dahhak, 'Amr b. Al-'As Dhat As-Salasil tayammum (Imam Ahmad/Abu Dawud; the Prophet smiled), ʿudwan + ẓulm, the Fire "easy for Allah"; 4:31 kabā'ir (Ibn 'Abbas: as many as seven hundred; Al-Jalalayn murder/fornication/theft), nukaffir al-sayyi'at — Salman Friday hadith, seven destructive sins (Abu Hurayrah), the greatest-sins hadiths (Anas; Ibn Abi Bakrah; Ibn Mas'ud with 25:68-70; 'Abdullah b. 'Amr; cursing parents), mudkhalan/madkhan = Paradise; 4:32 tamanni — Umm Salamah's occasion ("Would that we were men..."), men/women each a share of their own earning (Ibn Jarir; Ibn 'Abbas — inheritance), "ask Allah of His bounty" (Ibn Kathir — wish does not change the decree), Maududi's diversity-and-tranquillity note; 4:33 mawali = heirs (Ibn 'Abbas, Mujahid, Sa'id b. Jubayr, Qatadah etc.; Ibn Jarir: cousin = mawla), covenant-inheritance — 'aqadat/'aqadat allies, sixth; Ibn 'Abbas/ Al-Bukhari on Muhajirun-Ansar brotherhood inheritance cancelled, pledges remain for cooperation/advice, bequests allowed; abrogated by 8:75/33:6 (Al-Jalalayn), Maududi on alliance/adoption custom; 4:34 qawwamun — protector/maintainer/caretaker/leader (Ibn Kathir; Maududi's qawwam/qayyim definition), faddala not superiority but endowment (Maududi), prophethood/leadership exclusivity + "people who appoint a woman..." (Al-Bukhari), anfaqu (dowry, maintenance; 2:228), qanitat (Ibn 'Abbas: obedient), hafizat lil-ghayb (As-Suddi: honour + property; best-woman hadith via Ibn Jarir/Ibn Abi Hatim), nushuz graded sequence — wa'z, hajr in the bed (Ibn 'Abbas: back-to-her; also not speaking per As-Suddi/Ad-Dahhak/'Ikrimah), darb ghayr mubarrih (Muslim's Farewell-hajj Jabir hadith; Ibn 'Abbas: not violent; Al-Hasan: not severe; Mu'awiyah b. Haydah's rights list), obedience → no sabīl; Allah 'Aliy Kabir as the wife's Protector; Maududi: obedience to God precedes the husband; 4:35 shiqaq → two arbiters with consent, delegation (husband: divorce/compensation; wife: separation), Ibn 'Abbas on fault-finding and restitution, binding decisions (Abu 'Umar b. 'Abdul-Barr's summary; disagreement → no dissolution), inheritance detail re agreeing spouse, "Allah gives preference to staying together," in yurida islahan; 4:36 the moral ladder — Mu'adh hadith (Allah's right; servants' right), parents (31:14, 17:23), relatives (sadaqah + silah), orphans, masakin (9:60), near/distant neighbour (Ibn 'Abbas/'Ikrimah/Mujahid etc.: kin vs. stranger; Mujahid also travelling companion), the five neighbour hadiths (Jibril twice; best companions/neighbours; Al-Miqdad zina/theft; Ibn Mas'ud's triad; 'A'ishah closest door), sahib bi al-janb (Al-Jalalayn: companion/colleague/wife; Maududi's transient claims), ibn al-sabil, ma malakat aymanukum (final-illness advice; Al-Miqdam sadaqah hadith; Ibn 'Amr food hadith — Muslim; slave food/clothing/work — Muslim; servant's mouthful — Al-Bukhari), the mukhtal fakhur censure (Mujahid; Ibn Jarir/Abu Raja'; isbal hadith); 4:37 miserliness — the three verbs (own bukhl, commanding bukhl, concealing the favour), Prophet's "what disease is more serious" + shuhh hadith, kufr = covering (bakhil as kafir-vis-à-vis the favour), the Salaf's Jews-and-knowledge reading, muhin punishment; 4:38 ri'a (ostentation) — hypocrites and Meccans (Al-Jalalayn), the Jewish leaders' show of following Ibrahim (Ibn 'Abbas), the first-three-in-the-Fire hadith ("You lie — you only wanted it said 'generous'...", full reward in this life), Satan as qarin, sa'a qarinan; 4:39 mādha 'alayhim — the rhetorical invitation to faith, Last Day, and spending from razaq, Allah 'Alim of intentions (Ibn Kathir: guides those deserving success); 4:40 mithqal dharratin (smallest ant — Al-Jalalayn; 99:6–8; 21:47; 31:16), the intercession hadiths (mustard seed / least speck — Two Sahihs), yuda'ifuha ten-to-700+, "great reward" = Paradise (Abu Hurayrah, 'Ikrimah, Sa'id b. Jubayr, Al-Hasan, Qatadah, Ad-Dahhak), the Abu 'Uthman/Abu Hurayrah two-million report (Ibn Abi Hatim; caution), believer vs. disbeliever accounting (Anas; Sa'id b. Jubayr on Abu Talib's dabdah).
- Chapter 4 batch 2 COMPLETE: 40/40 verses delivered so far. Next batch: 4:41–60 when requested.
